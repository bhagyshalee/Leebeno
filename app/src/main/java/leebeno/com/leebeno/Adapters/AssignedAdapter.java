...
public class AssignedAdapter extends RecyclerView.Adapter<AssignedAdapter.ViewHolder> {
    ...
    public AssignedAdapter(ArrayList<RejectModel> rejectModelArrayList, Context context) {
//        super();
...
//        holder.rejecteddate.setText(rejectModel.getRejected_date());
        holder.placeddate.setText(rejectModel.getPlaceddate());
        holder.usd.setText("$ " + rejectModel.getUsd());
        holder.rejecteddatetv.setText("Assign Date : ");
...
//            String newDateString = df.format(startDate);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView jobtile, customer_name, comment, placeddate, rejecteddate, usd, rejecteddatetv;
        int pos;
        ...
        public ViewHolder(View itemView) {
            ...
            rejecteddatetv = (TextView) itemView.findViewById(R.id.rejecteddatetv);
