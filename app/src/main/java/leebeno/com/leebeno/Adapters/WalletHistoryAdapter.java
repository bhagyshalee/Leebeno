...
public class WalletHistoryAdapter extends RecyclerView.Adapter<WalletHistoryAdapter.ViewHolder> {
    ...
    public WalletHistoryAdapter(List<String> additionalServicesTitle, Context context, List<String> additionalServicesPrice , List<String> additionalServicesTranId
    ...
    public void onBindViewHolder(final WalletHistoryAdapter.ViewHolder holder, final int position) {
        ...
        holder.transactionId.setText(additionalServicesTranId.get(position));
